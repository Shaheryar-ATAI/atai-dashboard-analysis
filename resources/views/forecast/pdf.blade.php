...
<table class="no-b" style="margin-bottom:6px;">
    <tr class="no-b">
        ...
        <td style="width:150px;"><div class="ibox">{{ $submissionDate }}</div></td>
    </tr>
    <tr class="no-b">
...
<table class="mt6">
    ...
    @empty
        <tr><td colspan="6" class="center small">No rows</td></tr>
    @endforelse
    <tr class="total-row">
        <td colspan="4" class="right">Total New Current Month Forecasted Orders</td>
...
<table class="mt6">
    ...
    @endforelse
    <tr class="total-row">
        <td colspan="4" class="right">Total Carry-over</td>
