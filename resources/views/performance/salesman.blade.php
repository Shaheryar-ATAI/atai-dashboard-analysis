...
<main class="container-fluid py-4">
    ...
    <div class="card-body">
      ...
      <span class="badge-total text-bg-primary" id="badgeInq">Inquiries: SAR 0</span>
      <span class="badge-total text-bg-success" id="badgePO">POs: SAR 0</span>
        </div>
      </div>
    </div>
  </div>
