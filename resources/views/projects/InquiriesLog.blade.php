    ...
    <script>
        ...
        function initProjectsTable(selector, status, sumSelector) {
            ...
            const statusMap = { bidding: 'Bidding', inhand: 'In-Hand', lost: 'Lost' };
        ...
        function openProjectModalFromData(row) {
            ...
            // decide the modal using the robust normalizer
            ...
            if (kind === 'bidding') {
                ...
                renderChecklist('biddingChecklist', checklistBidding, 'bid', p.checklist || {});
            ...
            if (kind === 'inhand') {
                ...
                renderChecklist('inhandChecklist', checklistInhand, 'ih', p.checklist || {});
