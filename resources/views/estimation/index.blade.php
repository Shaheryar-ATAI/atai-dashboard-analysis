    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item"><a class="nav-link" href="{{ route('performance.index') }}">Performance Report</a>
                </li>
                <li class="nav-item"><a class="nav-link" href="{{ route('performance.area') }}">Area Summary</a></li>
                <li class="nav-item"><a class="nav-link" href="{{ route('performance.salesman') }}">Salesman Summary</a>
                </li>
                <li class="nav-item"><a class="nav-link" href="{{ route('performance.product') }}">Product Summary</a>
                </li>
...
<div class="container-fluid py-4">
    ...
    <ul class="nav nav-pills mb-3" role="tablist">
        <li class="nav-item">
            <button class="nav-link active" data-bs-toggle="pill" data-bs-target="#pane-all" type="button">All</button>
        </li>
        <li class="nav-item">
