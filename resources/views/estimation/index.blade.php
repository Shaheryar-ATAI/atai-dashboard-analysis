    ...
    <div class="estimator-toolbar glass-row mb-3">
        ...
        <div class="et-center">
            <div id="metricToggle" class="metric-toggle pill-chips" role="tablist">
                <input type="radio" class="btn-check" name="metric" id="metricValue" value="value" autocomplete="off" checked>
                <label class="chip-btn" for="metricValue">Value</label>

                <input type="radio" class="btn-check" name="metric" id="metricCount" value="count" autocomplete="off">
                ...
                .then(payload => {
                    ...
                    if (payload.mode === 'all') {
                        ...
                        Highcharts.chart('chart-estimator', {
                            ...
                            plotOptions: {
                                pie: {
                                    ...
                                    dataLabels: {
                                        ...
                                        style:{ color:'#E8F0FF', fontWeight:500, fontSize:'14px', textOutline:'2px rgba(0,0,0,0.6)' },
                            ...
                            series: [{ name: metric === 'count' ? 'Projects' : 'Value', colorByPoint:true, data: dataAll }],
                    ...
                    <div style="margin:2px 0;">
                      ...
                      Value: <b>${v}</b>
                            ...
                            plotOptions: {
                                pie: {
                                    ...
                                    dataLabels: {
                                        enabled:true, distance:20, softConnector:true, connectorWidth:1.3,
                                        connectorColor:'rgba(255,255,255,0.35)',
                                        style:{ color:'#E8F0FF', fontWeight:600, fontSize:'14px', textOutline:'2px rgba(0,0,0,0.6)' },
                                        formatter: function () {
                            ...
                            series: [{ name: metric === 'count' ? 'Projects' : 'Value', colorByPoint:true, data: dataSingle }],
                            lang:{ noData:'No estimator data available.' },
                            noData:{ style:{ fontSize:'14px', color:'#E0E7FF', fontWeight:600 } }
                        });
                    }
                    ...
                    Highcharts.chart('chartProduct', {
                        ...
                        yAxis: {
                            ...
                            labels:{
                                style:{ color:'#E0E7FF', fontWeight:600, fontSize:'12px' },
                                formatter(){ return (metric === 'count') ? Number(this.value).toLocaleString() : fmtCompactSAR(this.value); }
                            }
                        },
