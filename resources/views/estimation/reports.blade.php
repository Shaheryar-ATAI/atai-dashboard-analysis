                ...
                <div class="tab-pane fade show active" id="all" role="tabpanel" tabindex="0">
                    <div class="d-flex flex-wrap align-items-center gap-2 mb-3">
                        <div class="input-group w-auto">
                            ...
                            <input id="searchAll" type="text" class="form-control" placeholder="Project, client, location…">
                        </div>
                    </div>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select id="technical_submittal" name="technical_submittal" class="form-select form-select-sm">
                                        <option value="">Select...</option>
