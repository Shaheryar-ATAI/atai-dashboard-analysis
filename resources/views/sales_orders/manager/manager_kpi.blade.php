...
@push('head')
    ...
    <style>
        ...
        /* ===== Switcher & panels ===== */
        #kpiSwitcher{ position:relative; }
        #panelChart{ position:relative; z-index:1; }
        #kpi_status_monthly{ height:420px; }
        ...
        .kpi-value{
            ...
            min-height: 120px; font-weight: 800;
        }
        ...
        .month-title{ font-weight:700; opacity:.95; }
        .month-grid{
            display:grid; grid-template-columns: repeat(2, minmax(0,1fr));
            gap: 8px;
        }
        .month-kpi{ background: rgba(255,255,255,.045); border-radius:8px; padding:8px; }
        .month-kpi .label{ font-size:12px; opacity:.75; }
        .month-kpi .val{ font-weight:700; font-size:13px; }
        ...
        /* ===== Status chips ===== */
        #statusChips.pill-chips{ display:flex; gap:.5rem; flex-wrap:wrap; }
        ...
        @media (max-width: 992px){
            #monthBoard.months-wrap{ grid-template-columns: repeat(2, minmax(220px,1fr)); }
        }
    </style>
...
// compute monthly target for the logged-in region
            ...
            async function loadKPIs(){
                ...
                try {
                    ...
                    if (!didInitFamily) { currentFamily = ''; didInitFamily = true; }
                    buildChips(
                        'familyChips',
                        fams,
                        currentFamily,
